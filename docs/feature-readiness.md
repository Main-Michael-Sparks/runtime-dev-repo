...
readActionEvents(filter, options)
  ...
  -> no durability, process-restart recovery, cross-process pub/sub, or stream-delta materialization
```
...
durable action event storage/replay surface beyond retained in-memory replay
